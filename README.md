...
- [Installation](#installation)
  * [Avec un virtualenv (bonne pratique)](#avec-un-virtualenv--bonne-pratique-)
  * [Sans virtualenv (#yolo)](#sans-virtualenv---yolo-)
...
- [Format de données](#format-de-donn-es)
  ...
  * [représentation interne disponible dans les templates](#repr-sentation-interne-disponible-dans-les-templates)
  * [Configuration résultant de ces données:](#configuration-r-sultant-de-ces-donn-es-)
